...
data.speakers = {"JOSEP ANTONI DURAN I LLEIDA": {name: "JOSEP ANTONI DURAN I LLEIDA", title: "Grupo Convergència i Unió"}, "JOSEP ANTONI DURAN I LLEIDA": {name: "Josep Antoni Duran i Lleida", title: "Grupo Convergència i Unió"}, "JOSÉ LUIS RODRÍGUEZ ZAPATERO": {name: "José Luis Rodríguez Zapatero", title: "Grupo Socialista (PSOE)"}, "JOSU IÑAKI ERKOREKA GERVASIO": {name: "JOSU IÑAKI ERKOREKA GERVASIO", title: "Grupo PNV"}, "MARIANO RAJOY BREY": {name: "MARIANO RAJOY BREY", title: "Grupo Popular (PP)"}, "MARIANO RAJOY BREY": {name: "Mariano Rajoy Brey", title: "Grupo Popular (PP)"}, "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN": {name: "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN", title: "Grupo Popular (PP)"}, "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN": {name: "María Soraya Sáenz de Santamaría Antón", title: "Grupo Popular (PP)"}, "MARÍA TERESA FERNÁNDEZ DE LA VEGA SANZ": {name: "María Teresa Fernández de la Vega Sanz", title: "Grupo Socialista (PSOE)"}, "PEDRO SOLBES MIRA": {name: "Pedro Solbes Mira", title: "Grupo Socialista (PSOE)"}, "RAMÓN AGUIRRE RODRÍGUEZ": {name: "RAMÓN AGUIRRE RODRÍGUEZ", title: "Grupo Popular (PP)"}, "RAMÓN AGUIRRE RODRÍGUEZ": {name: "Ramón Aguirre Rodríguez", title: "Grupo Popular (PP)"}, "INMACULADA RODRÍGUEZ-PIÑERO FERNÁNDEZ": {name: "INMACULADA RODRÍGUEZ-PIÑERO FERNÁNDEZ", title: "Grupo Socialista (PSOE)"}, "INMACULADA RODRÍGUEZ-PIÑERO FERNÁNDEZ": {name: "Inmaculada Rodríguez-Piñero Fernández", title: "Grupo Socialista (PSOE)"}, "BEATRIZ RODRÍGUEZ-SALMONES CABEZA": {name: "BEATRIZ RODRÍGUEZ-SALMONES CABEZA", title: "Grupo Popular (PP)"}, "BEATRIZ RODRÍGUEZ-SALMONES CABEZA": {name: "Beatriz Rodríguez-Salmones Cabeza", title: "Grupo Popular (PP)"}, "CARME CHACÓN PIQUERAS": {name: "Carme Chacón Piqueras", title: "Grupo Socialista (PSOE)"}, "MARÍA DEL PILAR BARREIRO ÁLVAREZ": {name: "MARÍA DEL PILAR BARREIRO ÁLVAREZ", title: "Grupo Popular (PP)"}, "MARÍA PILAR BARREIRO ÁLVAREZ": {name: "María Pilar Barreiro Álvarez", title: "Grupo Popular (PP)"}, "JESÚS CUADRADO BAUSELA": {name: "JESÚS CUADRADO BAUSELA", title: "Grupo Socialista (PSOE)"}, "JESÚS CUADRADO BAUSELA": {name: "Jesús Cuadrado Bausela", title: "Grupo Socialista (PSOE)"}, "CELIA VILLALOBOS TALERO": {name: "CELIA VILLALOBOS TALERO", title: "Grupo Popular (PP)"}, "CELIA VILLALOBOS TALERO": {name: "Celia Villalobos Talero", title: "Grupo Popular (PP)"}, "FRANCISCO MANUEL CAAMAÑO DOMÍNGUEZ": {name: "Francisco Manuel Caamaño Domínguez", title: "Grupo Socialista (PSOE)"}, "MARÍA SALOM COLL": {name: "MARÍA SALOM COLL", title: "Grupo Popular (PP)"}, "MARÍA SALOM COLL": {name: "María Salom Coll", title: "Grupo Popular (PP)"}, "ESTEBAN GONZÁLEZ PONS": {name: "ESTEBAN GONZÁLEZ PONS", title: "Grupo Popular (PP)"}, "ESTEBAN GONZÁLEZ PONS": {name: "Esteban González Pons", title: "Grupo Popular (PP)"}, "ELENA SALGADO MÉNDEZ": {name: "Elena Salgado Méndez", title: "Grupo Socialista (PSOE)"}};
