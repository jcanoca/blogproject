...
data.speakers = {"JOAN RIDAO I MARTÍN": {name: "JOAN RIDAO I MARTÍN", title: "Grupo Izquierda Unida"}, "JOAN RIDAO I MARTÍN": {name: "Joan Ridao i Martín", title: "Grupo Izquierda Unida"}, "JOSÉ LUIS RODRÍGUEZ ZAPATERO": {name: "José Luis Rodríguez Zapatero", title: "Grupo Socialista (PSOE)"}, "JOSU IÑAKI ERKOREKA GERVASIO": {name: "JOSU IÑAKI ERKOREKA GERVASIO", title: "Grupo PNV"}, "MARIANO RAJOY BREY": {name: "MARIANO RAJOY BREY", title: "Grupo Popular (PP)"}, "MARIANO RAJOY BREY": {name: "Mariano Rajoy Brey", title: "Grupo Popular (PP)"}};
