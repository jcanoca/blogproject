...
data.speakers = {"JOSÉ LUIS RODRÍGUEZ ZAPATERO": {name: "José Luis Rodríguez Zapatero", title: "Grupo Socialista (PSOE)"}, "GASPAR LLAMAZARES TRIGO": {name: "GASPAR LLAMAZARES TRIGO", title: "Grupo Izquierda Unida"}, "MARIANO RAJOY BREY": {name: "MARIANO RAJOY BREY", title: "Grupo Popular (PP)"}, "MARIANO RAJOY BREY": {name: "Mariano Rajoy Brey", title: "Grupo Popular (PP)"}, "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN": {name: "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN", title: "Grupo Popular (PP)"}, "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN": {name: "María Soraya Sáenz de Santamaría Antón", title: "Grupo Popular (PP)"}, "MARÍA TERESA FERNÁNDEZ DE LA VEGA SANZ": {name: "María Teresa Fernández de la Vega Sanz", title: "Grupo Socialista (PSOE)"}, "GUILLERMO MARISCAL ANAYA": {name: "GUILLERMO MARISCAL ANAYA", title: "Grupo Popular (PP)"}, "GUILLERMO MARISCAL ANAYA": {name: "Guillermo Mariscal Anaya", title: "Grupo Popular (PP)"}, "MANUEL MARÍA CHAVES GONZÁLEZ": {name: "Manuel María Chaves González", title: "Grupo Socialista (PSOE)"}, "JOSEBA AGIRRETXEA URRESTI": {name: "JOSEBA AGIRRETXEA URRESTI", title: "Grupo PNV"}, "JOSEBA AGIRRETXEA URRESTI": {name: "Joseba Agirretxea Urresti", title: "Grupo PNV"}, "TRINIDAD JIMÉNEZ GARCÍA-HERRERA": {name: "Trinidad Jiménez García-Herrera", title: "Grupo Socialista (PSOE)"}, "ARSENIO FERNÁNDEZ DE MESA DÍAZ DEL RÍO": {name: "ARSENIO FERNÁNDEZ DE MESA DÍAZ DEL RÍO", title: "Grupo Popular (PP)"}, "ARSENIO FERNÁNDEZ DE MESA DÍAZ DEL RÍO": {name: "Arsenio Fernández de Mesa Díaz del Río", title: "Grupo Popular (PP)"}, "CARME CHACÓN PIQUERAS": {name: "Carme Chacón Piqueras", title: "Grupo Socialista (PSOE)"}, "IGNACIO COSIDÓ GUTIÉRREZ": {name: "IGNACIO COSIDÓ GUTIÉRREZ", title: "Grupo Popular (PP)"}, "IGNACIO COSIDÓ GUTIÉRREZ": {name: "Ignacio Cosidó Gutiérrez", title: "Grupo Popular (PP)"}, "ALFREDO PÉREZ RUBALCABA": {name: "Alfredo Pérez Rubalcaba", title: "Grupo Socialista (PSOE)"}, "IGNACIO GIL LÁZARO": {name: "IGNACIO GIL LÁZARO", title: "Grupo Popular (PP)"}, "IGNACIO GIL LÁZARO": {name: "Ignacio Gil Lázaro", title: "Grupo Popular (PP)"}};
