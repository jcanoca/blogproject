...
data.speakers = {"MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN": {name: "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN", title: "Grupo Popular (PP)"}, "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN": {name: "María Soraya Sáenz de Santamaría Antón", title: "Grupo Popular (PP)"}, "MARÍA TERESA FERNÁNDEZ DE LA VEGA SANZ": {name: "María Teresa Fernández de la Vega Sanz", title: "Grupo Socialista (PSOE)"}, "RAMÓN AGUIRRE RODRÍGUEZ": {name: "RAMÓN AGUIRRE RODRÍGUEZ", title: "Grupo Popular (PP)"}, "RAMÓN AGUIRRE RODRÍGUEZ": {name: "Ramón Aguirre Rodríguez", title: "Grupo Popular (PP)"}, "ELENA SALGADO MÉNDEZ": {name: "Elena Salgado Méndez", title: "Grupo Socialista (PSOE)"}, "LUISA FERNANDA RUDI ÚBEDA": {name: "LUISA FERNANDA RUDI ÚBEDA", title: "Grupo Popular (PP)"}, "LUISA FERNANDA RUDI UBEDA": {name: "Luisa Fernanda Rudi Ubeda", title: "Grupo Popular (PP)"}, "MANUEL MARÍA CHAVES GONZÁLEZ": {name: "Manuel María Chaves González", title: "Grupo Socialista (PSOE)"}, "JUAN JOSÉ MATARÍ SÁEZ": {name: "JUAN JOSÉ MATARÍ SÁEZ", title: "Grupo Popular (PP)"}, "JUAN JOSÉ MATARÍ SÁEZ": {name: "Juan José Matarí Sáez", title: "Grupo Popular (PP)"}};
