...
data.speakers = {"JOSÉ LUIS CENTELLA GÓMEZ": {name: "JOSÉ LUIS CENTELLA GÓMEZ", title: "Grupo Izquierda Unida"}, "JOSÉ LUIS CENTELLA GÓMEZ": {name: "José Luis Centella Gómez", title: "Grupo Izquierda Unida"}, "MARIANO RAJOY BREY": {name: "Mariano Rajoy Brey", title: "Grupo Popular (PP)"}, "JOSEP ANTONI DURAN I LLEIDA": {name: "JOSEP ANTONI DURAN I LLEIDA", title: "Grupo Convergència i Unió"}, "JOSEP ANTONI DURAN I LLEIDA": {name: "Josep Antoni Duran i Lleida", title: "Grupo Convergència i Unió"}, "ALFREDO PÉREZ RUBALCABA": {name: "ALFREDO PÉREZ RUBALCABA", title: "Grupo Socialista (PSOE)"}, "ALFREDO PÉREZ RUBALCABA": {name: "Alfredo Pérez Rubalcaba", title: "Grupo Socialista (PSOE)"}, "JOSÉ ANTONIO ALONSO SUÁREZ": {name: "JOSÉ ANTONIO ALONSO SUÁREZ", title: "Grupo Socialista (PSOE)"}, "JOSÉ ANTONIO ALONSO SUÁREZ": {name: "José Antonio Alonso Suárez", title: "Grupo Socialista (PSOE)"}, "MARÍA SORAYA SÁENZ DE SANTAMARÍA ANTÓN": {name: "María Soraya Sáenz de Santamaría Antón", title: "Grupo Popular (PP)"}, "JULIO VILLARRUBIA MEDIAVILLA": {name: "JULIO VILLARRUBIA MEDIAVILLA", title: "Grupo Socialista (PSOE)"}, "JULIO VILLARRUBIA MEDIAVILLA": {name: "Julio Villarrubia Mediavilla", title: "Grupo Socialista (PSOE)"}, "ALBERTO RUIZ-GALLARDÓN JIMÉNEZ": {name: "Alberto Ruiz-Gallardón Jiménez", title: "Grupo Popular (PP)"}, "CARMEN MONTÓN GIMÉNEZ": {name: "CARMEN MONTÓN GIMÉNEZ", title: "Grupo Socialista (PSOE)"}, "CARMEN MONTÓN GIMÉNEZ": {name: "Carmen Montón Giménez", title: "Grupo Socialista (PSOE)"}, "RAFAEL SIMANCAS SIMANCAS": {name: "RAFAEL SIMANCAS SIMANCAS", title: "Grupo Socialista (PSOE)"}, "RAFAEL SIMANCAS SIMANCAS": {name: "Rafael Simancas Simancas", title: "Grupo Socialista (PSOE)"}, "ANA MARÍA PASTOR JULIÁN": {name: "Ana María Pastor Julián", title: "Grupo Popular (PP)"}};
