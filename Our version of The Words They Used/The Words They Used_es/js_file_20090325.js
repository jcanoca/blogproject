...
data.topics = [{name: "economía", re: /\b(economía)\b/gi, x: 60.0, y: 60.0}, {name: "defensa", re: /\b(defensa)\b/gi, x: 92.0, y: 28.0}, {name: "fiscal", re: /\b(fiscal)\b/gi, x: 112.0, y: 16.0}, {name: "economía española", re: /\b(economía española)\b/gi, x: 130.0, y: 14.0}, {name: "españoles", re: /\b(españoles)\b/gi, x: 144.0, y: 10.0}, {name: "militares", re: /\b(militares)\b/gi, x: 158.0, y: 10.0}, {name: "justicia", re: /\b(justicia)\b/gi, x: 172.0, y: 10.0}, {name: "fiscalía", re: /\b(fiscalía)\b/gi, x: 184.0, y: 8.0}, {name: "fomento", re: /\b(fomento)\b/gi, x: 196.0, y: 8.0}, {name: "proceso", re: /\b(proceso)\b/gi, x: 206.0, y: 6.0}, {name: "seguridad", re: /\b(seguridad)\b/gi, x: 216.0, y: 6.0}, {name: "militar", re: /\b(militar)\b/gi, x: 226.0, y: 6.0}, {name: "fuerzas", re: /\b(fuerzas)\b/gi, x: 236.0, y: 6.0}, {name: "recursos", re: /\b(recursos)\b/gi, x: 246.0, y: 6.0}, {name: "investigación", re: /\b(investigación)\b/gi, x: 256.0, y: 6.0}].map(topic);
