...
politi.model.DebateData = function(data,dl) {
	...
	if(this.loadable) this._url = "data/politilines2/" + data.url + "?" + Math.floor(Math.random() * Math.pow(10,10));
	this._loaded = false;
}
...
politi.model.DebateCategories.prototype.load = function() {
	if(!this._inited) {
		this._inited = true;
		var http = new haxe.Http("data/politilines2/debates.json" + "?" + Math.floor(Math.random() * Math.pow(10,10)));
		http.onData = $closure(this,"handleData");
		// http.request(true);
		http.request(false);
	}
...
politi.view.WordNode.tip = null;
politi.model.DebateData.DIRECTORY = "data/politilines2/";
...
politi.model.DebateCategories.PATH = "data/politilines2/debates.json";
